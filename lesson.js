/*** EduForge plugin — แบบฝึกหัดการดำเนินการทางคณิตศาสตร์ ***************
 * ตัวสร้างใบงาน บวก / ลบ / คูณ / หาร (ตั้งหลัก) ทำงานฝั่งหน้าเว็บล้วน
 *   - บวก/ลบ: 1–8 หลัก · คูณ: ตัวตั้ง≤4 ตัวคูณ≤3 · หาร: ยาว/สั้น ลงตัว/มีเศษ
 *   - A4 แนวตั้ง ตารางช่อง · เฉลย (inline/พิมพ์พร้อมเฉลย/QR) · จับเวลา
 *   - หน้าความสูงคงที่ + กันล้น: ทุกชนิดพอดี 1 หน้า ไม่ตกหล่น
 ***********************************************************************/
(function () {
